...
#1. Making use of builtin count method:
...
#2. calculating zero count through lengths 
...
zero_count = len(arr) - len(new_arr)
...
#3. calculating zero count by using coditional operator inside loop
